...
class Pay_Retail extends StatefulWidget {
  const Pay_Retail({Key? key}) : super(key: key);

  @override
  State<Pay_Retail> createState() => _Pay_RetailState();
}

class _Pay_RetailState extends State<Pay_Retail> {

  List<Map<String,dynamic>> title = [
    {"item":"TÊN NGÂN HÀNG:", "name":'Á Châu Bank (ACB)', "copy":"copy", "value": false},
    {"item":"SỐ TÀI KHOẢN:", "name":"382827", "copy":"copy", "value": true},
    {"item":"CHỦ KHOẢN:", "name":'HOANG THE SONG', "copy":"copy", "value": false},
  ];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: WidgetText(
                            ...
                            title: "Để nạp Bookcoin vào ví, Quý khách vui lòng Quét mã QR và nhập Mã Giao Dịch sau vào nội dung chuyển khoản",
                            maxLine: 2,
                ...
                AppValue.vSpaceSmall,
                Padding(
                  padding: EdgeInsets.only(left: AppValue.widths*0.075),
                  child: Row(
                    children: [
                      SvgPicture.asset("assets/icons/back_icon_sp.svg"),
                      AppValue.hSpaceTiny,
                      WidgetText(
                        title: "LƯU Ý KHI QUY ĐỔI: ",
                        style: AppStyle.DEFAULT_16.copyWith(fontSize:15, color: COLORS.RED2),
                      ),
                      WidgetText(
                        title: "1.000 VNĐ = 1 BCoin",
                        style: AppStyle.DEFAULT_16.copyWith(fontSize:15, color: COLORS.BLACK),
                      ),
                    ],
                  ),
                ),
