...
class Tab_Survey_Favorite extends StatefulWidget {
  const Tab_Survey_Favorite({Key? key}) : super(key: key);

  @override
  State<Tab_Survey_Favorite> createState() => _Tab_Survey_FavoriteState();
}

class _Tab_Survey_FavoriteState extends State<Tab_Survey_Favorite> {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              AppNavigator.navigateTabSurveyFavoriteWidget();
                            },
                            child: Container(
