...
class buildDropdownListBookReading extends StatefulWidget {
  ...
  @override
  State<buildDropdownListBookReading> createState() => _buildDropdownListBookReadingState();
}

class _buildDropdownListBookReadingState extends State<buildDropdownListBookReading> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        isSelect ? BlocBuilder<ListBookReadingBloc, ListBookReadingState>(
          builder: (context, state) {
            if(state is UpdateGetListBookReadingState){
              return Stack(
